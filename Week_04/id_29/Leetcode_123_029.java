package leetcode.Algorithms._101_200._123_BestTimeToBuyAndSellStockIII;
...
public class BestTimeToBuyAndSellStockIII {
    ...
    public int maxProfit(int[] prices) {
        ...
        int[] firstBuy = new int[len];
        int[] firstSell = new int[len];

        int[] secondBuy = new int[len];
        int[] secondSell = new int[len];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sellStockIII.maxProfit(new int[]{7,6,4,3,1}));
        System.out.println(sellStockIII.maxProfit(new int[]{3,3,5,0,0,3,1,4}));
        System.out.println(sellStockIII.maxProfit(new int[]{1,2,3,4,5}));
    }
}
